"""
Benchmark de inferencia — Unsloth / MLX (Apple Silicon Metal)
Modelo: TinyLlama-1.1B-Chat-v1.0 via mlx_lm
...
def main():
    print(f"[Unsloth/MLX] Cargando {MODEL_NAME} ...")
    ...
    summary = {
        "framework":           "Unsloth / mlx_lm (Metal)",
        "model":               MODEL_NAME,
    ...
    out_file = OUT_DIR / "benchmark_unsloth.json"
